  ...
  <div style={{ background: "linear-gradient(180deg, #eaf6f3 0%, #f6fafd 100%)", minHeight: "100vh" }}>
    ...
    <Container className="text-center py-5">
      <h1 style={{ fontWeight: 700, fontSize: 48 }}>
        Take Control of Your <span style={{ color: "#4f8a7d" }}>Finances</span>
      </h1>
      <p style={{ color: "#6c757d", fontSize: 18, marginBottom: 32 }}>
        Smart budgeting made simple. Track expenses, set goals, and achieve financial freedom with Budget Bee.
      </p>
      <Button
        onClick={() => navigate("/budgetpage")}
        variant="success"
        size="lg"
        style={{ marginBottom:10 ,borderRadius: 30, padding: "12px 32px", fontSize: 20, boxShadow: "0 2px 8px #b5d1c9" }}
      >
        Get Started &rarr;
      </Button>
      ...
      <Row className="mt-5 justify-content-center">
        <Col md={4} className="mb-4">
          <Card style={{ border: "none", borderRadius: 16, boxShadow: "0 2px 12px #e3e9ed" }}>
            <Card.Body>
              <div style={{
                background: "#e7f4ef",
                borderRadius: "50%",
              ...
              <Card.Text>
                Monitor your spending patterns and identify areas where you can save money effortlessly.
              </Card.Text>
            </Card.Body>
          </Card>
        </Col>
        <Col md={4} className="mb-4">
          <Card style={{ border: "none", borderRadius: 16, boxShadow: "0 2px 12px #e3e9ed" }}>
            <Card.Body>
              ...
              <Card.Text>
                Create personalized budgets that adapt to your lifestyle and help you reach your financial goals.
              </Card.Text>
            </Card.Body>
          </Card>
        </Col>
        <Col md={4} className="mb-4">
          <Card style={{ border: "none", borderRadius: 16, boxShadow: "0 2px 12px #e3e9ed" }}>
            <Card.Body>
              ...
              <Card.Text>
                Set financial targets and get insights on how to reach them faster with our intelligent recommendations.
              </Card.Text>
            </Card.Body>
          </Card>
        </Col>
